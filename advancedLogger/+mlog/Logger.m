classdef Logger < handle & matlab.mixin.SetGetExactNames & ...
    ...
    methods
        ...
        function varargout = error(obj, varargin)
            % write an error message to the log 
            % Adds a new message to the Logger, with level ERROR
            % and text
            %
            % Syntax:
            %       logObj.error(MessageText)
            %       logObj.error(MessageText, sprintf_args...)

            obj.write('ERROR', varargin{:});

        end %function

        function varargout = warning(obj, varargin)
            % write a warning message to the log 
            % Adds a new message to the Logger, with level WARNING
            % and text
            %
            % Syntax:
            %       logObj.warn(MessageText)
            %       logObj.warn(MessageText, sprintf_args...)

            obj.write('WARNING', varargin{:});

        end %function

        function varargout = info(obj, varargin)
            % write a info message to the log 
            % Adds a new message to the Logger, with level INFO
            % and text
            %
            % Syntax:
            %       logObj.info(MessageText)
            %       logObj.info(MessageText, sprintf_args...)
            
            obj.write('INFO', varargin{:});
            
        end %function

        function varargout = message(obj, varargin)
            % write a message to the log 
            % Adds a new message to the Logger, with level MESSAGE
            % and text
            %
            % Syntax:
            %       logObj.write(MessageText)
            %       logObj.write(MessageText, sprintf_args...)
            
            obj.write('MESSAGE', varargin{:});
            
        end %function

        function varargout = debug(obj, varargin)
            % write a debugging info message to the log 
            % Adds a new message to the Logger, with level DEBUG
            % and text
            %
            % Syntax:
            %       logObj.write(MessageText)
            ...
            obj.write('DEBUG', varargin{:});
            
        end %function


        function varargout = detail(obj, varargin)
            % write a detailed debugging info message to the log 
            % Adds a new message to the Logger, with level DETAIL
            % and text
            %
            % Syntax:
            %       logObj.write(MessageText)
            ...
            obj.write('DETAIL', varargin{:});
            
        end %function

        function varargout = trace(obj, varargin)
            % write a trace info message to the log 
            % Adds a new message to the Logger, with level TRACE
            % and text
            %
            % Syntax:
            %       logObj.write(MessageText)
